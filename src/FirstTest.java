...
//
    ...
    @Test
    public void saveTwoArticlesToMyListDz()
    {
        WebElement element_skip = driver.findElementById("org.wikipedia:id/fragment_onboarding_skip_button");
        element_skip.click();
        ...
        waitForElementAndClick(By.xpath("//*[contains(@text, 'Python (programming language)')]"),
                "Cannot find 'Python (programming language)' searching by 'Python'",
                15);

        waitForElementPresent(By.xpath("//*[contains(@text, 'Python (programming language)')]"),
        ...
        String title_in_saved_articles = waitForElementAndGetAttribute
        ...
        String title_of_saved_article = waitForElementAndGetAttribute
                (By.xpath("//*[contains(@text, 'Python (programming language)')]"),
                        "text",
                        "Cannot find title of article by 'Python (programming language)'",
                        15);

        Assert.assertEquals("Article titles does not equal each other",
